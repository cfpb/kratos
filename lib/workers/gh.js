...
(function() {
  var add_asset, add_remove_user, add_user, conf, couch_utils, create_team, get_gh_team_id, get_gh_team_type, gh_conf, git_client, git_url, handle_add_remove_gh_user_role, handle_add_remove_user, handle_create_team, handle_remove_repo_event, iced, output, remove_repo, remove_user, request, teams, user_db, users, utils, _, __iced_k, __iced_k_noop, _get_or_create_repo,
  ...
  handle_add_remove_gh_user_role = function(event, user, callback) {
    ...
    (function(_this) {
      return (function(__iced_k) {
        ...
        teams._get_all_teams(__iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              err = arguments[0];
