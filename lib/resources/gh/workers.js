...
(function() {
  var Promise, add_asset, auth, emptyResolve, get_gh_role, get_gh_team_id, get_gh_team_ids, get_gh_username, gh, git, handle_add_gh_rsrc_role, handle_add_repo, handle_add_user, handle_create_team, handle_deactivate_user, handle_remove_gh_rsrc_role, handle_remove_repo, handle_remove_user, has_gh_team_membership_through_other_role, teams_api, users, _,
  ...
  get_gh_team_ids = function(user) {
    return teams_api.get_all_team_roles_for_user(user).then(function(team_roles) {
      var gh_team_ids;
  ...
  add_asset = function(asset_data, team) {
