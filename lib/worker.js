...
(function() {
  var conf, couch_utils, db, follow, handlers, org, orgs, validate, worker, _, _i, _len;
  ...
  for (_i = 0, _len = orgs.length; _i < _len; _i++) {
    ...
    worker.start_worker(db, handlers, validate._get_doc_type, worker.get_plugin_handlers);
  }
