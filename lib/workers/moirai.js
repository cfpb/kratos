...
(function() {
  var Promise, auth, conf, emptyResolve, getOrCreateAsset, getTeamAssetDetails, handleAddCluster, handleAddData, handleAddUser, handleRemoveCluster, handleRemoveUser, moirai, moiraiConf, querystring, slug, teams, users, _;
  ...
  getTeamAssetDetails = function(assets, team, actor) {
    var query, url;
    query = {
      clusterIds: _.pluck(assets, 'couch_id')
    };
