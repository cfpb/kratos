...
(function() {
  var GIT_URL, KRATOS_DIR, Promise, TEMPLATE_DIR, c, conf, exec, get_authenticated_repo_url, get_github_team_name, gh_conf, git, git_client, mkdir, path, request, utils, _;
    ...
    repo: {
      create: function(gh_repo_opts) {
        ...
        return git.post({
          ...
          if (((_ref = err.msg) != null ? (_ref1 = _ref.errors) != null ? (_ref2 = _ref1[0]) != null ? _ref2.message : void 0 : void 0 : void 0) === 'name already exists on this account') {
            return git.find_one(url, function(repo) {
              return repo.name === gh_repo_opts['name'];
            });
          } else {
            return Promise.reject(err);
          }
      ...
      pushTemplate: function(repo_data) {
        ...
        return exec('git init', {
          ...
          return pushTemplate(repo_data);
        }).then(function() {
          return Promise.resolve(repo_data);
        });
      },
      createPush: function(gh_repo_opts) {
        return c.repo.create(gh_repo_opts).next(function(repo_data) {
