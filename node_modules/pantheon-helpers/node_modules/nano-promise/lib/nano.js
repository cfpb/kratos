...
module.exports = exports = nano = function dbScope(cfg) {
  ...
  var _pRelax = Promise.denodeify(_relax);
  ...
  function updates(qs, callback) {
    if (typeof qs === 'function' || qs === 'promise') {
      callback = qs;
      qs = {};
    }
    return relax({
  ...
  function compactDb(dbName, ddoc, callback) {
    if (typeof ddoc === 'function' || ddoc === 'promise') {
      callback = ddoc;
      ddoc = null;
    }
    return relax({
