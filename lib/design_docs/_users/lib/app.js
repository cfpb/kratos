...
(function() {
  var auth, dd_methods, h, validation, _,
  ...
  module.exports = {
    ...
    updates: {
      do_action: function(user, req) {
        var acting_user, action, body, container, i, key, merge_target, old_container, role, value;
        if (!user) {
        ...
        if (action === 'r+') {
          ...
          container = user.data;
          old_container = JSON.parse(JSON.stringify(container));
