...
(function() {
  var Promise, couch_utils, doAction, process_req, request, resources, teams, utils, uuid, _;
  ...
  teams.add_asset = function(db, team_name, resource, asset_data) {
    var team_id;
    team_id = 'team_' + team_name;
    return db.get(team_id, 'promise').then(function(team) {
      var handler, _ref;
  ...
  teams.handle_add_asset = function(req, resp) {
    var db, params, team_name, _ref;
    _ref = process_req(req), db = _ref[0], team_name = _ref[1], params = _ref[2];
    return teams.add_asset(db, team_name, params.resource, req.body).then(function(team) {
