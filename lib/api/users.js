...
(function() {
  var conf, couch_utils, doAction, isInt, process_req, user_db, users, utils, uuid, validate, _,
  ...
  users.get_users = function(opts, callback) {
    ...
    if ((_ref = opts.all) !== 'true' && _ref !== true) {
      _.extend(params, {
        startkey: [true],
        endkey: [true, {}]
      });
  ...
  users.get_users_by_name = function(names, callback) {
    var ids;
  ...
  users.handle_get_users_by_name = function(req, resp) {
    users = req.body;
    if (_.isArray(users)) {
