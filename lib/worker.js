...
(function() {
  var conf, couch_utils, db, feed, follow, get_new_synced_state, get_unsynced_audit_entries, iced, opts, org, orgs, resources, team_validation, update_audit_entries, update_audit_entry, user_validation, utils, wh, _, __iced_k, __iced_k_noop, _i, _len;
  ...
  feed.filter = function(doc, req) {
    if (!user_validation.is_user(doc)) {
      return false;
    } else {
      return true;
    }
